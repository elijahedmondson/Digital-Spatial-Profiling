...
# KPC_R172H <- mt_list[[1]]
# KPC_R270H <- mt_list[[2]]
# R270H_R270H <- mt_list[[3]]


R172H <- read_excel("F:/GeoMX KPC/WTA_11232022/processed_data/STRAIN_p05_KPC_PDAC.xlsx", 
                    sheet = "R172H Step2")
R270H <- read_excel("F:/GeoMX KPC/WTA_11232022/processed_data/STRAIN_p05_KPC_PDAC.xlsx", 
                    sheet = "R270H Step2")
Null <- read_excel("F:/GeoMX KPC/WTA_11232022/processed_data/STRAIN_p05_KPC_PDAC.xlsx", 
                    sheet = "Null Step2")
